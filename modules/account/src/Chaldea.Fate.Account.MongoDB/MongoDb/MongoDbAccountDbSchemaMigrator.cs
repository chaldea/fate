...
{
    public class MongoDbAccountDbSchemaMigrator : IAccountDbSchemaMigrator , ITransientDependency
    {
        private readonly IServiceProvider _serviceProvider;

        public MongoDbAccountDbSchemaMigrator(IServiceProvider serviceProvider)
        {

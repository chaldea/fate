    ...
    public class AccountHttpApiHostModule : AbpModule
    {
        ...
        private void ConfigureVirtualFileSystem(ServiceConfigurationContext context)
        {
            ...
            if (hostingEnvironment.IsDevelopment())
            {
                ...
                {
                    options.FileSets.ReplaceEmbeddedByPhysical<AccountDomainSharedModule>(
                        Path.Combine(hostingEnvironment.ContentRootPath,
                            $"..{Path.DirectorySeparatorChar}Chaldea.Fate.Account.Domain.Shared"));
                    options.FileSets.ReplaceEmbeddedByPhysical<AccountDomainModule>(
                        Path.Combine(hostingEnvironment.ContentRootPath,
                            $"..{Path.DirectorySeparatorChar}Chaldea.Fate.Account.Domain"));
                    options.FileSets.ReplaceEmbeddedByPhysical<AccountApplicationContractsModule>(
                        Path.Combine(hostingEnvironment.ContentRootPath,
                            $"..{Path.DirectorySeparatorChar}Chaldea.Fate.Account.Application.Contracts"));
                    options.FileSets.ReplaceEmbeddedByPhysical<AccountApplicationModule>(
                        Path.Combine(hostingEnvironment.ContentRootPath,
                            $"..{Path.DirectorySeparatorChar}Chaldea.Fate.Account.Application"));
                });
            }
        }

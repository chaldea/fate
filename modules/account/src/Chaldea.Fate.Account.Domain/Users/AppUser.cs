...
namespace Chaldea.Fate.Account.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update AccountDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update AccountEfCoreEntityExtensionMappings to extend the IdentityUser entity

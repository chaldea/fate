...
namespace Chaldea.Fate.Account.MongoDB.Samples
{
     ...
     */
    [Collection(AccountTestConsts.CollectionDefinitionName)]
    public class SampleRepositoryTests : AccountMongoDbTestBase
    {

...
namespace Chaldea.Fate.Template.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update TemplateDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update TemplateEfCoreEntityExtensionMappings to extend the IdentityUser entity
